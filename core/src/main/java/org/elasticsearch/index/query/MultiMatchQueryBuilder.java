...
public class MultiMatchQueryBuilder extends AbstractQueryBuilder<MultiMatchQueryBuilder> {
  public static String NAME="multi_match";
  private Object text;
  ...
  static MultiMatchQueryBuilder PROTOTYPE=new MultiMatchQueryBuilder(null);
  public enum Type {  /** 
 ...
 */
  PHRASE_PREFIX(MatchQuery.Type.PHRASE_PREFIX,0.0f,new ParseField("phrase_prefix"));   private MatchQuery.Type matchQueryType;
  private float tieBreaker;
  private ParseField parseField;
  public Type(  MatchQuery.Type matchQueryType,  float tieBreaker,  ParseField parseField){
